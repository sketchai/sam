...
# from sketch_data.catalog_primitive.shaper_line import ShaperLine
...
class TestShaperSketch(unittest.TestCase):
    ...
    def test_export(self):
        sketch = ShaperConversion()
        sketch.add(Line(pnt1_X=11, pnt1_Y=22, pnt2_X=33, pnt2_Y=44))
        sketch.add(Circle(center=[0.,5.], radius=1))

        out_path = 'tests/unit/asset/out/export_shaper_sketch.py'
